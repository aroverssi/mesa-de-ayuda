...
document
  .getElementById("backToUserRoleSelection")
...
document
  .getElementById("backToAdminRoleSelection")
  .addEventListener("click", () => {
...
function mostrarTickets(isAdmin) {
  ...
  const emailFiltro = document.getElementById(isAdmin ? null : "emailFilter")?.value || "";
...
// Función para calcular y mostrar el KPI mensual con mes y año
function calcularKpiMensual() {
  ...
  const mesActual = inicioMes.toLocaleString("es-ES", { month: "long", year: "numeric" });
